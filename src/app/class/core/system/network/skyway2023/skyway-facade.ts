...
// SkyWay SDKをラップするファサードクラス（元祖v1.17.0より移植）
export class SkyWayFacade {
  ...
  private getLobbyNames(): string[] {
    ...
    for (let channel of (this.context?.authToken.scope.app as any).channels ?? []) {
